...
public class SearchResultInputView {
    ...
    public SearchResultInputView(Scanner scanner) {
    ...
    public String inputCategoryCode() {
        List<String> categoryCodeList = List.of("MT1", "CS2", "PS3", "SC4", "AC5", "PK6", "OL7", "SW8", "BK9", "CT1", "AG2", "PO3", "AT4", "AD5", "FD6", "CE7", "HP8", "PM9");
        ...
        int userSelectInfraNumber = scanner.nextInt();
        String categoryCode = categoryCodeList.get(userSelectInfraNumber - 1);
